 		...
 		%>
 		 --%>
				...
				<div class="small-img-row">
					...
					<div class="small-img-col">
						<img src="images/shoes-6.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/shoes-5.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/shoes-4.jpg" width="100%" class="small-img">
					</div>
			...
			<div class="col-2">
				...
				<!-- <a href="CartServlet" class="btn" id="myButton1" onclick="change()">Add To Cart </a> -->
				<a href = "CartServlet?itemid=8&itemname=adidasshoes&itemprice=2500&itemqty=1&itemimage=images/product-2.jpg&tax=0.3"
				 class="btn" id="myButton1" onclick="change()">add to cart
				</a>
