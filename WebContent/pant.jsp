...
<body>
	...
	<%
		List<Product> list=(List<Product>)request.getAttribute("PANTLIST");
	%>
 ...
 <div class="col-2">
				...
				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/pant-2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/pant-1.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/pant-3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/pant-4.jpg" width="100%" class="small-img">
					</div>
			...
			<div class="col-2">
				...
				<a href="CartServlet?itemid=7&itemname=Grey Pant&itemprice=500&itemqty=1&itemimage=images/product-3.jpg"
	...
	function change() // no ';' here
{
    ...
    if (elem.value=="Add To Cart") elem.value = "Added";
	 ...
	 <!-- select orderid ,listid,itemname,itemprice,itemquantity from orderlist 
	 where orderid IN (select orderid from orders where emailid='nn@gmail.com'); -->